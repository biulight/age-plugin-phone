...
use crate::recipient::{Recipient, TaggedStanza, validate_stanza};
...
mod tests {
    ...
    fn round_trip_and_replay() {
        ...
        let vector: serde_json::Value =
            serde_json::from_str(include_str!("../../test-vectors/offline-envelope-v2.json"))
                .unwrap();
        assert_eq!(
    ...
    fn pairing_transcript() {
        ...
        let vector: serde_json::Value = serde_json::from_str(include_str!(
            "../../test-vectors/pairing-transcript-v2.json"
        ))
        .unwrap();
        assert_eq!(
