...
日期：2026-09-09。状态：PR 2 / M1 已实现双密钥后端与独立硬件 metadata，
验证及剩余门槛见 [M1 记录](macos-m1-evidence.md)；PR 1 已加入隔离验证工具与 ADR 草案；M0 的 cargo install / CryptoKit 路径已通过本机验证，
...
首次实施范围为 PR 1；当前已推进 PR 2 / M1，仍不等于完整 macOS 产品验收完成。当前计划不承诺固定日历工期；M0 结束后根据硬件、原生构建路径、OS
