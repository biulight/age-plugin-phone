...
日期：2026-09-09。状态：PR 1 已加入隔离验证工具与 ADR 草案；M0 的 cargo install / CryptoKit 路径已通过本机验证，
...
首次实施范围为 PR 1；已添加工具及草案不等于 M0 硬件和签名验收完成。当前计划不承诺固定日历工期；M0 结束后根据硬件、原生构建路径、OS
