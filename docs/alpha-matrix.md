...
| Encrypt and decrypt with released reference age; multiple files and multiple phone identities | Required | Required | age 1.3.1 passed two-file native/cross-client phone and recovery paths; portable identity-v1 coverage now preserves continuation past a nonmatching phone identity, while packaged physical multiple-phone validation remains open |
