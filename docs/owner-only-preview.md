...
- Optional foreground-only Wi-Fi unwrap experimentation through one explicit private IPv4 route;
  no discovery, background wake, pairing, fallback, or production transport claim.
